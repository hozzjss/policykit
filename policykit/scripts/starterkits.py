...
for perm in admin_user_base_const_perms:
    ...
    admin_user_base_role_discord.permissions.add(p1)
    admin_user_base_role_discourse.permissions.add(p1)

for perm in admin_user_mod_const_perms:
    p1 = Permission.objects.get(name=perm)
    admin_user_mod_role_slack.permissions.add(p1)
    admin_user_mod_role_reddit.permissions.add(p1)
...
for perm in democracy_base_const_perms:
    ...
    democracy_base_role_discord.permissions.add(p1)
    democracy_base_role_discourse.permissions.add(p1)

for perm in democracy_voter_const_perms:
    p1 = Permission.objects.get(name=perm)
    democracy_voter_role_slack.permissions.add(p1)
    democracy_voter_role_reddit.permissions.add(p1)
...
for perm in dictator_base_const_perms:
    ...
    dictator_base_role_discord.permissions.add(p1)
    dictator_base_role_discourse.permissions.add(p1)

for perm in dictator_dictator_const_perms:
    p1 = Permission.objects.get(name=perm)
    dictator_dictator_role_slack.permissions.add(p1)
    dictator_dictator_role_reddit.permissions.add(p1)
...
for perm in jury_base_const_perms:
    ...
    jury_base_role_discord.permissions.add(p1)
    jury_base_role_discourse.permissions.add(p1)
